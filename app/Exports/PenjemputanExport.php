...
use App\Policies\JemputlaundryPolicy;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A3:F3'.$event->sheet->getHighestRow())->applyFromArray([
                    'borders' => [
                        'allborders' => [
