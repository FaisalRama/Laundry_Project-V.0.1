                        ...
                        <tfoot>
                            <tr valign="bottom">
                                ...
                                <td rowspan="4">
                                    ...
                                    <input type="text" class="form-control" name="bayar" style="width:170px"
                                        value="0">
                                    <div>
                                        <button class="btn btn-primary" style="margin-top:10px;width:170px"
                                            type="submit" required>Bayar</button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" align="right">Pajak
                                    <input type="number" value="0" min="0" class="qty" name="pajak"
                            ...
                            <tbody>
                                @foreach ($member as $b)
                                    <tr>
                                        ...
                                        <td>{{ $b->tlp }}</td>
                                        <td>{{ $b->alamat }}</td>
                                        <td><button class="pilihMemberBtn btn btn-success" type="button">Pilih</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <tbody>
                                @foreach ($paket as $p)
                                    <tr>
                                        ...
                                        <td>{{ $p->nama_paket }}</td>
                                        <td>{{ $p->harga }}</td>
                                        <td><button type="button" class="pilihPaketBtn btn btn-success"
