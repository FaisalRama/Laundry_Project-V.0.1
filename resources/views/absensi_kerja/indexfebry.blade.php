                    ...
                    <table id="tbl-barang" class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($absensi_kerja as $mbr)
                                <tr>
                                    <td>{{ $i = isset($i) ? ++$i : ($i = 1) }}<input type="text" hidden
                                            class="id" value="{{ $mbr->id }}"></td>
                                    ...
                                    <td>
                                        <select name="status" class="status form-control">
                                            <option value="masuk"
                                                {{ $mbr->status == 'masuk' ? 'selected disabled' : '' }}>
                                                Masuk
                                            </option>
                                    ...
                                    <td>
                                        <button class="btn waktu_beres-absensi_kerja btn-secondary" type="button"
                                            {{ $mbr->waktu_selesai_kerja }}><a>SELESAI</a></button>
                                    </td>
                                    <td>
                                        <!-- Update Data -->
