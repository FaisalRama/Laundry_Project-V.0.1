    ...
    <div class="modal-dialog modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="penggunaan_barang">
                    @csrf
                    <div id="method"></div>
                    ...
                    <div class="form-group">
                        <label for="exampleInputText">Waktu Pakai : </label>
                        <input type="date" class="form-control" value="{{ date('Y-m-d') }}" name="waktu_pakai"
                            id="waktu_pakai">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputText">Nama Pemakai : </label>
                        <input type="text" class="form-control" name="nama_pemakai" id="nama_pemakai"
