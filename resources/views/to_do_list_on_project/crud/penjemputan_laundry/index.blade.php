...
@section('title-of-content')
    PENJEMPUTAN LAUNDRY (to-do list)
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="tbl-barang" class="table table-hover">
                ...
                <tbody>
                    @foreach ($todopenjemputan as $mbr)
                        <tr>
        ...
        @include(
            'to_do_list_on_project.crud.penjemputan_laundry.form'
        )
        @include(
            'to_do_list_on_project.crud.penjemputan_laundry.js'
        )
    @endsection
