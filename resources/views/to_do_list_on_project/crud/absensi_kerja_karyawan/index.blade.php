...
@section('title-of-content')
    ABSENSI KERJA KARYAWAN (to-do list)
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="tbl-barang" class="table table-hover">
                ...
                <tbody>
                    @foreach ($todoabsensikerjakaryawan as $mbr)
                        <tr>
        ...
        @include(
            'to_do_list_on_project.crud.absensi_kerja_karyawan.form'
        )
        @include(
            'to_do_list_on_project.crud.absensi_kerja_karyawan.js'
        )
    @endsection
