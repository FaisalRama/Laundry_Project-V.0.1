    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="tbl-barang" class="table table-hover">
                ...
                <tbody>
                    @foreach ($todopenggunaanbarang as $mbr)
                        <tr>
        ...
        @include(
            'to_do_list_on_project.crud.penggunaan_barang.form'
        )
        @include('to_do_list_on_project.crud.penggunaan_barang.js')
    @endsection
