    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="tbl-barang" class="table table-hover">
                ...
                <tbody>
                    @foreach ($todobaranginventaris as $mbr)
                        <tr>
        ...
        @include(
            'to_do_list_on_project.crud.barang_inventaris.form'
        )
        @include('to_do_list_on_project.crud.barang_inventaris.js')
    @endsection
