                    ...
                    <div class="form-group row col-6">
                        <label for="" class="col-sm-4 col-form-label"><button type="button"
                                class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalMember"><i
                                    class="ti-plus"></i></button> Nama/JK</label>
                    ...
                    <table id="tblTransaksi" class="display expandable-table" style="width:100%">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><input type="number" value="0" min="0" id="diskon" name="diskon"
                                        style="width: 100px"></td>
                            </tr>
                            <tr>
                                <td colspan="3" align="right">Pajak <input type="text" readonly value="3" min="0"
                            ...
                            <tr>
                                ...
                                <td><input type="number" value="0" min="0" id="biaya_tambahan" name="biaya_tambahan"
                                        style="width: 100px"></td>
                            </tr>
                            <tr style="background:black;color:white;font-weight:bold;font-size:1em">
                                <td colspan="3" align="right">Total Bayar Akhir</td>
                                <td><input id="total" name="total" class="form-control-plaintext text-white" readonly>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <tbody>
                        @foreach ($member as $b)
                            <tr>
                                ...
                                <td>{{ $b->tlp }}</td>
                                <td>{{ $b->alamat }}</td>
                                <td> <button type="button" class="pilihMemberBtn btn btn-primary"
                    ...
                    <tbody>
                        @foreach ($paket as $b)
                            <tr>
                                ...
                                <td>{{ $b->nama_paket }}</td>
                                <td>{{ $b->harga }}</td>
                                <td> <button type="button" class="pilihPaketBtn btn btn-primary"
                                        data-dismiss="modal">Pilih</button></td>
                            </tr>
                        @endforeach
                    </tbody>
